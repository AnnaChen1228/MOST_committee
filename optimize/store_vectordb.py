...
def main():
    ...
    # # 2. 定義兩個不同的資料庫路徑
    path_basic = "database/vectorstore_basic_industry"       # 存 Title, Keywords
    path_abstract = "database/vectorstore_abstract_industry" # 存 Abstracts
    
    # # 3. 分別執行儲存
    store_basic_db(path_basic, industry_authors_dict, embedding_model)
    store_abstract_db(path_abstract, industry_projects_dict, embedding_model)
